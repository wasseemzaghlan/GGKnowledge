...
import { ChevronRight, FileText, MessageSquare, ListChecks } from "lucide-react";
...
interface QuestionSectionNavProps {
  sections: Section[];
  className?: string;
}

export function QuestionSectionNav({ sections, className }: QuestionSectionNavProps) {
  return (
    <div className={cn(
